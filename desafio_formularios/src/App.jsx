...
const App = () => {
  ...
  return (
    <form onSubmit={(event) => event.preventDefault()}>
      ...
      {resultado ? <p style={{fontWeight: 'bold', fontSize: '18px', fontFamily: 'Arial'}}>{resultado}</p> : <button onClick={handleClick} type="button" style={{backgroundColor: '#2bb1ff', color: 'white', marginTop: 10}}>Próxima</button>}
    </form>);
};
